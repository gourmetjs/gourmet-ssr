  ...
  onDefaultConfig(context) {
    return {
      babel: {
        ...
        stage+target?
        envName: context.stageIs("production") ? "production" : "development",

        // If this is set to `true`, Babel's project-wide and file-relative babelrc files are
        // used in addition to settings generated by Gourmet Builder.
        babelrc: true,

        // This `loose` option is given to `@babel/preset-env` and other plugins whenever possible.
        loose: true,

        // If this is set to `"entry"`, an entry file containing `require("@babel/pollyfill")`
        // is automatically inserted to all page entries.
        useBuiltIns: "usage",

        // Where to load browserslist configuration:
        //  - "gourmet": global setting from `builder.runtime` of `gourmet_config.js`.
        //  - "root": project-wide configuration file at project's root directory
        //  - "file": file-relative configuration file
